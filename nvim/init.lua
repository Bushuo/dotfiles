...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'graphql', 'html', 'javascript', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'rust', 'toml', 'tsx', 'typescript', 'vim', 'vimdoc' }
